import { thumbnails } from '../blocks/thumbnails'

export function BlockCard({ label, thumb, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
...
export function TemplateCard({ name, description, thumb, previewImage, onApply }) {
  return (
    <button
      type="button"
      onClick={onApply}
