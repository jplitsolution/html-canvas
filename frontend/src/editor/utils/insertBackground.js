 ...
 */
export function insertBackgroundWithText(editor, imageUrl) {
  if (!canInsert()) {
 ...
 */
export function updateOverlayOpacity(component, opacity) {
  const overlay = component.find?.((c) => 
    c.get('tagName') === 'div' && 
 ...
 */
export function getOverlayOpacity(component) {
