...
export function formatSpacing(box) {
...
export function nudgeSpacing(box, side, delta) {
  return {
    ...box,
...
export function parseCornerIndex(value) {
...
export function parseTextSizeIndex(value) {
...
export function textSizeIndexToCss(index) {
